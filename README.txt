= MysteryScience notes

This is a really old gem that is required by 'statsample'.  This gem
then required a very old version of 'prawn'.  Since we don't
use the PDF report output, that code can be removed.

Because this is a really old gem, there is no github repo for it,
nor was there a gemspec, so we've created both to allow us to
modify this code.
